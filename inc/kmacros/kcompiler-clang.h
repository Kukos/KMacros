#ifndef KCOMPILER_CLANG_H
#define KCOMPILER_CLANG_H
...
/*
    ...
    Here put all macros, functions, directives from clang compiler
...
#ifndef KMACROS_H
#error "Never include <kmacros/kcompiler-clang.h> directly, use <kmacros/kmacros.h> instead."
#endif
...
#define KPRAGMA_CLANG(mode, msg)    _Pragma(KTOSTRING(clang mode msg))

/* Private macro, do no use */
#define KDIAG_CLANG(msg)            KPRAGMA_CLANG(diagnostic, msg)
 ...
 */
#if KCOMPILER_MAJOR_VERSION >= 12
#define KCOMPILER_ERROR(msg)        KPRAGMA_CLANG(error, msg)
#else
#define KCOMPILER_ERROR(msg)
#endif

/**
 * This is just like ‘pragma clang error’ except that a warning message is issued
 * instead of an error message.
 * Unless -Werror is in effect, in which case this pragma will generate an error as well.
 */
#if KCOMPILER_MAJOR_VERSION >= 12
#define KCOMPILER_WARNING(msg)      KPRAGMA_CLANG(warning, msg)
#else
 ...
 */
#define KCOMPILER_DIAG_PUSH()       KDIAG_CLANG(push)
 ...
 * Please note that clang shows you a warning when you put a semicolon at the end
 */
#define KCOMPILER_DIAG_POP()        KDIAG_CLANG(pop)
 ...
 * Please note that clang shows you a warning when you put a semicolon at the end
 */
#define KCOMPILER_DIAG_WARNING(str) KDIAG_CLANG(warning str)
 ...
 * Please note that clang shows you a warning when you put a semicolon at the end
 */
#define KCOMPILER_DIAG_ERROR(str)   KDIAG_CLANG(error str)
 ...
 */
#define KCOMPILER_DIAG_IGNORE(str)  KDIAG_CLANG(ignored str)
 ...
 */
#define KEXPECT_PROBABILITY(cond, val, prob)     __builtin_expect(cond, val)
...
*/
#define KADD_OVERFLOW(x, y, res)      __builtin_add_overflow(x, y, res)

#define KUADD_OVERFLOW(x, y, res)     __builtin_uadd_overflow(x, y, res)
#define KUADDL_OVERFLOW(x, y, res)    __builtin_uaddl_overflow(x, y, res)
#define KUADDLL_OVERFLOW(x, y, res)   __builtin_uaddll_overflow(x, y, res)

#define KSADD_OVERFLOW(x, y, res)     __builtin_sadd_overflow(x, y, res)
#define KSADDL_OVERFLOW(x, y, res)    __builtin_saddl_overflow(x, y, res)
#define KSADDLL_OVERFLOW(x, y, res)   __builtin_saddll_overflow(x, y, res)

#define KSUB_OVERFLOW(x, y, res)      __builtin_sub_overflow(x, y, res)

#define KUSUB_OVERFLOW(x, y, res)     __builtin_usub_overflow(x, y, res)
#define KUSUBL_OVERFLOW(x, y, res)    __builtin_usubl_overflow(x, y, res)
#define KUSUBLL_OVERFLOW(x, y, res)   __builtin_usubll_overflow(x, y, res)

#define KSSUB_OVERFLOW(x, y, res)     __builtin_ssub_overflow(x, y, res)
#define KSSUBL_OVERFLOW(x, y, res)    __builtin_ssubl_overflow(x, y, res)
#define KSSUBLL_OVERFLOW(x, y, res)   __builtin_ssubll_overflow(x, y, res)

#define KMUL_OVERFLOW(x, y, res)      __builtin_mul_overflow(x, y, res)

#define KUMUL_OVERFLOW(x, y, res)     __builtin_umul_overflow(x, y, res)
#define KUMULL_OVERFLOW(x, y, res)    __builtin_umull_overflow(x, y, res)
#define KUMULLL_OVERFLOW(x, y, res)   __builtin_umull_overflow(x, y, res)

#define KSMUL_OVERFLOW(x, y, res)     __builtin_smul_overflow(x, y, res)
#define KSMULL_OVERFLOW(x, y, res)    __builtin_smull_overflow(x, y, res)
#define KSMULLL_OVERFLOW(x, y, res)   __builtin_smulll_overflow(x, y, res)
